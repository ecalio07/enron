...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} RUN CODE WITH REDUCED DATASET}
        \PY{o}{\PYZpc{}}\PY{k}{run} ../dev/svm\PYZus{}gridsearch.ipynb
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} RUN CODE WITH FULL DATASET (AFTER MORE THAN TWO HOURS, IT WAS STILL RUNNING AND DIDN\PYZsq{}T DISPLAY RESULTS)}
        \PY{o}{\PYZpc{}}\PY{k}{run} ../dev/svm\PYZus{}gridsearch\PYZhy{}fulldataset.ipynb
\end{Verbatim}
...
GridSearchCV is not applied to this scenario.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} RUN CODE WITH REDUCED DATASET}
        \PY{o}{\PYZpc{}}\PY{k}{run} ../dev/bayes.ipynb
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} RUN CODE WITH FULL DATASET}
        \PY{o}{\PYZpc{}}\PY{k}{run} ../dev/bayes\PYZhy{}fulldataset.ipynb
\end{Verbatim}
...
{[}1, 5, 10{]},``max\_leaf\_nodes'': {[}None, 5, 10, 20{]}, \}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} RUN CODE WITH REDUCED DATASET}
        \PY{o}{\PYZpc{}}\PY{k}{run} ../dev/decitionTree\PYZus{}gridsearch.ipynb
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} RUN CODE WITH FULL DATASET (IT TAKES ALMOST ONE HOUR TO DISPLAY RESULTS)}
        \PY{o}{\PYZpc{}}\PY{k}{run} ../dev/decitionTree\PYZus{}gridsearch\PYZhy{}fulldataset.ipynb
\end{Verbatim}

    \subsection{Summury of Results}\label{summury-of-results}
...
the best accurace: around 9.91922 GridSearch presented best parameter
(kernel:rbf, C:1000, gamma: 0.001) for SVM scoring: 0.91772 In this
scenario, GaussianNB was the simplest and most efficient.
